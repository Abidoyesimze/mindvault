...
| `set_royalty_recipient(id, recipient)`                                       | `creator`                                                | `id: String`; `recipient: Option<Address>`                                                                                                                                                                                                           | `Result<(), Error>`                    | Set or clear (`None`) the per-resource royalty recipient that overrides the registry-level `fee_recipient` for this resource. Emits `setroyal` with the old and new recipient.                                                                                                                           |
...
| `set_fee_recipient(recipient)`                                               | `admin`                                                  | `recipient: Option<Address>`                                                                                                                                                                                                                         | `Result<(), Error>`                    | Update only the fee recipient address without changing fee rates.                                                                                                                                                                                                                                        |
